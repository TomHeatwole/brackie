...
values
  ...
  ('nit_champion', 'NIT champion', 'Correctly pick the NIT champion.', 20, 'user_input', '{"nit_options": ["Auburn", "Bradley", "Cal", "Colorado State", "Davidson", "Dayton", "George Mason", "George Washington", "Illinois State", "Kent State", "Liberty", "Murray State", "Navy", "Nevada", "New Mexico", "Oklahoma State", "SFA", "Saint Joseph''s", "Sam Houston", "Seattle U", "South Alabama", "St. Thomas (MN)", "Tulsa", "UC Irvine", "UIC", "UNCW", "UNLV", "Utah Valley", "Wake Forest", "Wichita State", "Wyoming", "Yale"]}'::jsonb),
